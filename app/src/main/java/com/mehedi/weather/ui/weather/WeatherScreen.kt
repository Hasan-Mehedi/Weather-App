...
import com.mehedi.weather.model.Hour
import com.mehedi.weather.model.Weather
import com.mehedi.weather.navigation.NavRoute
import com.mehedi.weather.ui.theme.WeatherTheme
import com.mehedi.weather.ui.weather.components.Animation
import com.mehedi.weather.ui.weather.components.HourlyComponent
import com.mehedi.weather.ui.weather.components.WeatherComponent
import com.mehedi.weather.utils.DateUtil.toFormattedDate
...
fun WeatherScreen(
    ...
    navigateToFutureWeatherScreen: () -> Unit
) {
    ...
    Scaffold(
        ...
        floatingActionButton = { FutureForecastButton(uiState = uiState, navHostController = navHostController ) },
...
@Composable
fun FutureForecastButton(
    uiState: WeatherUiState,
    navHostController: NavHostController

) {
    if (uiState.weather?.forecasts != null) {
        ExtendedFloatingActionButton(
            text = { Text(text = "Next days forecast") },
            icon = { },
            onClick = {
                navHostController.currentBackStackEntry?.savedStateHandle?.set(
                    "data",
                    uiState.weather.forecasts
                )
                navHostController.navigate(NavRoute.FutureWeather.path)
            }
        )
    }
}
